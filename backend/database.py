...
def init_db():
    ...
    headers = {
        CLIENTES_CSV: ["Dni", "Nombre", "Telefono", "Email", "Calle", "Localidad", "Provincia", "Codigo_Postal", "Numero_Explotacion", "Tipo", "Estado", "Estado_Nofence", "Importe_Nofence", "Collares", "Pedido_Nofence", "Importe_Factura_Nofence", "Importe_Cobrado_Cliente", "Beneficio", "Coordenadas_X", "Coordenadas_Y"],
